...
Constraints
    ...
    C12  Utilisation minimum (HARD): permanent employees must work >= 50% and
         fixed_term employees >= 30% of their contract hours summed over the
                    ...
                    for t in loc_active.get(l["site"], []):
                        ...
                        if eligible_emps:
                            prob += (
                                ...
                                f"headcount_{_safe(l['site'])}_{role}_w{t}",
                            )
