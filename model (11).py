...
def solve_allocation(employees, locations,
    ...
    # C12. Minimum utilisation: permanent >= 60%, fixed_term >= 40% of contract
    # hours each week. Pushes the model to use permanent staff as the backbone
    # of the schedule, with fixed-term filling next, and stagiairs only on the
    # remaining demand. Calibrated so the locks stay under demand on both
    # CC and Combibrug sides (see feasibility check in app).
