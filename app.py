...
# Daily scheduling is always on, and the 8-hour daily maximum is a fixed rule
...
with tab_run:
    ...
    if "mp_summary" in st.session_state:
        ...
        # ──────────────────────────────────────────────────────────────────
        # Daily timetable view — only when daily scheduling was enabled
        ...
        # ──────────────────────────────────────────────────────────────────
        # The schedule view — rows = employees, columns = weeks, cells = site
        # When site name and project name differ, the cell shows
