...
def _build_example_employee_xlsx():
    ...
    df = pd.DataFrame([
        # Combibrug
        {"id": 100, "name": "Anna Bakker",   "role": "Manager",         "company": "Combibrug", "contract_hours": 32, "hourly_cost": 38, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 101, "name": "Bram de Vries", "role": "Manager",         "company": "Combibrug", "contract_hours": 32, "hourly_cost": 38, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 110, "name": "Carla Jansen",  "role": "Combicoach",      "company": "Combibrug", "contract_hours": 24, "hourly_cost": 25, "contract_type": "permanent",  "end_week": "", "is_dreammaker": True},
        {"id": 111, "name": "Daan Smit",     "role": "Combicoach",      "company": "Combibrug", "contract_hours": 24, "hourly_cost": 25, "contract_type": "permanent",  "end_week": "", "is_dreammaker": True},
        {"id": 120, "name": "Eva van Dijk",  "role": "Buurtsportcoach", "company": "Combibrug", "contract_hours": 24, "hourly_cost": 27, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 121, "name": "Finn Visser",   "role": "Buurtsportcoach", "company": "Combibrug", "contract_hours": 24, "hourly_cost": 27, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 130, "name": "Gijs de Boer",  "role": "Combicoach",      "company": "Combibrug", "contract_hours": 20, "hourly_cost": 22, "contract_type": "fixed_term", "end_week": "", "is_dreammaker": True},
        {"id": 131, "name": "Hannah Mulder", "role": "Combicoach",      "company": "Combibrug", "contract_hours": 20, "hourly_cost": 22, "contract_type": "fixed_term", "end_week": "", "is_dreammaker": False},
        {"id": 140, "name": "Iris Bosch",    "role": "Stagiair",        "company": "Combibrug", "contract_hours": 16, "hourly_cost": 8,  "contract_type": "stage",      "end_week": "", "is_dreammaker": False},
        {"id": 141, "name": "Jens Hendriks", "role": "Stagiair",        "company": "Combibrug", "contract_hours": 16, "hourly_cost": 8,  "contract_type": "stage",      "end_week": "", "is_dreammaker": False},
        {"id": 142, "name": "Kim Peters",    "role": "Stagiair",        "company": "Combibrug", "contract_hours": 16, "hourly_cost": 8,  "contract_type": "stage",      "end_week": "", "is_dreammaker": False},
        # CC
        {"id": 200, "name": "Lars Vermeer",  "role": "Manager",         "company": "CC",        "contract_hours": 32, "hourly_cost": 38, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 210, "name": "Maud Willems",  "role": "Combicoach",      "company": "CC",        "contract_hours": 24, "hourly_cost": 25, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 211, "name": "Niels van Berg","role": "Combicoach",      "company": "CC",        "contract_hours": 24, "hourly_cost": 25, "contract_type": "permanent",  "end_week": "", "is_dreammaker": False},
        {"id": 220, "name": "Olivia Koster", "role": "Combicoach",      "company": "CC",        "contract_hours": 20, "hourly_cost": 22, "contract_type": "fixed_term", "end_week": "", "is_dreammaker": False},
        {"id": 221, "name": "Pieter de Wit", "role": "Combicoach",      "company": "CC",        "contract_hours": 20, "hourly_cost": 22, "contract_type": "fixed_term", "end_week": "", "is_dreammaker": False},
        {"id": 230, "name": "Quinn Janssen", "role": "Stagiair",        "company": "CC",        "contract_hours": 16, "hourly_cost": 8,  "contract_type": "stage",      "end_week": "", "is_dreammaker": False},
        {"id": 231, "name": "Rosa Meijer",   "role": "Stagiair",        "company": "CC",        "contract_hours": 16, "hourly_cost": 8,  "contract_type": "stage",      "end_week": "", "is_dreammaker": False},
    ])
    buf = BytesIO()
...
def _build_example_demand_xlsx():
    """Return an example demand template as Excel bytes."""
    df = pd.DataFrame([
        {"site": "Park Frankendael",    "project": "Combiworld-Oost", "company": "Combibrug", "weekly_hours": 24, "duration_months": 12, "start_week": 1, "min_headcount": 2, "project_leader_id": 100, "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "09:00-17:00", "notes": "Combiworld site, manager 100 leads"},
        {"site": "Sportpark Drieburg",  "project": "Combiworld-Oost", "company": "Combibrug", "weekly_hours": 16, "duration_months": 12, "start_week": 1, "min_headcount": 2, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "",            "notes": "Combiworld site, Four-Eyes"},
        {"site": "Buurtcentrum West",   "project": "MDT-West",        "company": "Combibrug", "weekly_hours": 20, "duration_months": 12, "start_week": 1, "min_headcount": 2, "project_leader_id": 101, "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "09:00-13:00", "notes": "MDT site, manager 101 leads"},
        {"site": "Buurtcentrum Diemen", "project": "MDT-Diemen",      "company": "Combibrug", "weekly_hours": 16, "duration_months": 12, "start_week": 1, "min_headcount": 2, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "",            "notes": "MDT site, Four-Eyes"},
        {"site": "BSC Oost",            "project": "BSC-Oost",        "company": "Combibrug", "weekly_hours": 20, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "13:00-17:00", "notes": "Buurtsportcoach project"},
        {"site": "BSC Zuid",            "project": "BSC-Zuid",        "company": "Combibrug", "weekly_hours": 16, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "",            "notes": "Buurtsportcoach project"},
        {"site": "MP Oost",             "project": "MP-Oost",         "company": "Combibrug", "weekly_hours": 16, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "",            "notes": "Maatschappelijke Participatie"},
        {"site": "MP Zuid",             "project": "MP-Zuid",         "company": "Combibrug", "weekly_hours": 20, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "09:00-13:00", "notes": "Maatschappelijke Participatie"},
        {"site": "Apollo",              "project": "CC-Centraal",     "company": "CC",        "weekly_hours": 24, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": 200, "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "09:00-17:00", "notes": "Combicoach project, manager 200 leads"},
        {"site": "Stadionplein",        "project": "CC-Centraal",     "company": "CC",        "weekly_hours": 20, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "13:00-17:00", "notes": "Combicoach project"},
        {"site": "Surinameplein",       "project": "CC-Zuid",         "company": "CC",        "weekly_hours": 16, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "09:00-17:00", "available_tue": "",            "available_wed": "09:00-17:00", "available_thu": "",            "available_fri": "",            "notes": "Combicoach project"},
        {"site": "Dukdalf",             "project": "CC-Noord",        "company": "CC",        "weekly_hours": 20, "duration_months": 12, "start_week": 1, "min_headcount": 0, "project_leader_id": "",  "available_mon": "",            "available_tue": "09:00-17:00", "available_wed": "",            "available_thu": "09:00-17:00", "available_fri": "09:00-13:00", "notes": "Combicoach project"},
    ])
    buf = BytesIO()
    df.to_excel(buf, index=False)
    return buf.getvalue()
...
freelancer_cost = st.sidebar.number_input(
    ...
    help="What Combibrug pays an external ZZP'er per hour. The cost the "
         "model compares internal staff against.",
)
...
with tab_upload:
    ...
    st.write(
        ...
        "If you don't have them yet, download the example files below, edit them "
        "with your own data, and upload them back."
    )
    ...
    with col_emp:
        ...
        st.download_button(
            ...
            data=_build_example_employee_xlsx(),
    ...
    with col_dem:
        ...
        st.download_button(
            ...
            data=_build_example_demand_xlsx(),
    ...
    def _load_uploaded(emp_bytes, emp_name, loc_bytes, loc_name):
        emp_buf = BytesIO(emp_bytes); emp_buf.name = emp_name
        loc_buf = BytesIO(loc_bytes); loc_buf.name = loc_name
    ...
    if missing_rate_ids:
        st.error(
            f"❌ {len(missing_rate_ids)} employee(s) have no hourly_cost in the "
            f"template: {missing_rate_ids}. Please fill in an hourly rate for every "
            f"employee and upload the file again."
        )
        st.stop()
    ...
    s4.metric("Rates from template", f"{len(employees_df)} / {len(employees_df)}")
...
with tab_inputs:
    ...
    c1, c2 = st.columns(2)
    c1.metric("Employees with rates", len(employees_df))
    if "is_dreammaker" in employees_df.columns:
        n_dream = int(employees_df["is_dreammaker"].sum())
    else:
        n_dream = 0
    c2.metric("Dreammakers", n_dream)
